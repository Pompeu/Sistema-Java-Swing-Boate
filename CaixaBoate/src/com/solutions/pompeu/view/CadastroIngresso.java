 ...
 * @author Pompeu
 */
public class CadastroIngresso extends MainClass {
    ...
    public CadastroIngresso(Principal principal) {
        this();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastroIngresso().setVisible(true);
